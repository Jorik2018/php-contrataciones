                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-title mb-0"><i class="far fa-keyboard me-1"></i>&nbsp;Registrar Nueva Respuesta</h5>
                            </div>
                            <div class="card-body">
                                <form id="formRespuesta" class="needs-validation" enctype="multipart/form-data" novalidate>
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <label for="proceso" class="form-label">Proceso</label>
                                            <select class="form-control" name="proceso" id="proceso" title="Seleccione" style="width: 100%;" required></select>
                                            <div class="invalid-feedback">Por favor seleccione el proceso de convocatoria.</div>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <label for="tipo" class="form-label">Tipo</label>
                                            <select class="form-control" name="tipo" id="tipo" title="Seleccione" style="width: 100%;" required>
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Ingrese Descripcion"  maxlength="500" required>
                                    ...
                                    <!--div class="text-end">
                                        <button type="submit" class="btn btn-danger">Guardar Convocatoria</button>
                                    </div-->
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table me-1"></i>&nbsp;Listado Respuesta</div>
                            <div class="card-body">
                                <div class="row">                                    
                                    <div class="col-md-3 mb-3">
                                    <select class="form-control" id="procesoBus" title="Seleccione" style="width: 100%;"></select>
                                    </div>
                                    <div class="col-md-2 mb-3">
                                        <select class="form-control" id="tipoBus" title="Seleccione" style="width: 100%;">
                                    ...
                                    <div class="col-md-5 mb-3">
                                        <input type="text" class="form-control" id="descripcionBus" placeholder="Ingrese descripcion resuesta" maxlength="500">
                                    </div> 
                                    <div class="col-md-2 mb-3 botRegistrar">
                                ...
                                <div class="row">                                        
                                    <table id="tResultRespuesta" class="display"></table>
                                </div>
                            </div>
                        </div>

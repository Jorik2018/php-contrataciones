<!DOCTYPE html>
<!-- saved from url=(0050)/contrataciones/vigentes/ -->
<html lang="es">

<?php include '../head.php'; ?>

<body data-rsssl="1"
	class="page-template page-template-wp-custom-template-pagina-columna page page-id-174 page-child parent-pageid-172 wp-custom-logo wp-embed-responsive elementor-default elementor-kit-67397">

	<a class="skip-link screen-reader-text"
		href="/contrataciones/vigentes/#wp--skip-link--target">Saltar al contenido</a>
	<div class="wp-site-blocks">
		<header class="wp-block-template-part">
			<div class="wp-block-group gapless-group has-vivid-red-background-color has-background is-layout-constrained wp-block-group-is-layout-constrained"
				style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px">
				<div class="wp-block-group is-layout-flow wp-block-group-is-layout-flow">
					<div class="wp-block-group alignfull site-header is-content-justification-space-between is-layout-flex wp-container-core-group-layout-3 wp-block-group-is-layout-flex"
						style="padding-top:var(--wp--custom--gap--vertical);padding-bottom:var(--wp--custom--gap--vertical)">
						<div
							class="wp-block-group site-brand is-nowrap is-layout-flex wp-container-core-group-layout-2 wp-block-group-is-layout-flex">
							...
							<div class="wp-block-group is-layout-flow wp-container-core-group-layout-1 wp-block-group-is-layout-flow"
								...
								<h1 class="wp-block-heading has-background-color has-text-color"
									style="font-size:15px;font-style:normal;font-weight:400">Senace – Servicio Nacional
									de Certificación Ambiental para las Inversiones Sostenibles</h1>
							</div>
						</div>
					</div>
				</div>
		...
		<footer class="site-footer-container wp-block-template-part">
			<div class="wp-block-group has-foreground-background-color has-background is-layout-constrained wp-block-group-is-layout-constrained"
				...
				<div class="wp-block-group is-layout-constrained wp-container-core-group-layout-12 wp-block-group-is-layout-constrained"
					style="border-bottom-color:#ffffff75;border-bottom-width:1px;margin-bottom:0;padding-bottom:var(--wp--preset--spacing--50)">
					<h3 class="wp-block-heading has-background-color has-text-color has-medium-font-size"
						style="margin-bottom:0;font-style:normal;font-weight:700">Categorías</h3>
				...
				<div class="wp-block-group is-layout-constrained wp-container-core-group-layout-16 wp-block-group-is-layout-constrained"
					...
					<div
						...
						<div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
							<div
								class="wp-block-group is-layout-constrained wp-container-core-group-layout-14 wp-block-group-is-layout-constrained">
								<h3 class="wp-block-heading has-background-color has-text-color has-link-color wp-elements-315e03006b3831d292cf7704e7d8e913"
									style="margin-bottom:var(--wp--preset--spacing--50)">Síguenos</h3>



								<ul
									class="wp-block-social-links has-icon-color is-style-logos-only is-content-justification-left is-layout-flex wp-container-core-social-links-layout-1 wp-block-social-links-is-layout-flex">
						...
						<div
							...
							<div
								class="wp-block-group is-layout-constrained wp-container-core-group-layout-15 wp-block-group-is-layout-constrained">
								<div
									...
									<figure class="wp-block-uagb-image__figure"><a class=""
											...
											rel="noreferrer noopener"><img decoding="async"
												srcset="/wp-content/uploads/2022/03/logo_senace200-300x94.png "
												sizes="(max-width: 480px) 150px"
												src="./Convocatorias vigentes – Senace – Servicio Nacional de Certificación Ambiental para las Inversiones Sostenibles_files/logo_senace200-300x94.png"
	...
	<script
		src="./Convocatorias vigentes – Senace – Servicio Nacional de Certificación Ambiental para las Inversiones Sostenibles_files/script-2.0.1.min.js"
		id="prevent-xss-vulnerability-js"></script>
